...
DATA.NETWORKING_EVENTS = [
  { id: "coffee", name: "Coffee Chat with an Alum", cost: 0, energy: 10, networkingGain: [1, 3], commGain: [0, 1], blurb: "Low-key, low-cost. Everyone starts here." },
  { id: "mixer", name: "Industry Happy Hour", cost: 40, energy: 15, networkingGain: [2, 5], commGain: [1, 2], blurb: "Business cards, small talk, and overpriced drinks." },
  { id: "conference", name: "Finance Conference", cost: 250, energy: 25, networkingGain: [4, 8], commGain: [1, 3], blurb: "A full day of panels and hallway networking." },
  { id: "gala", name: "Charity Gala", cost: 600, energy: 20, networkingGain: [6, 10], commGain: [2, 4], blurb: "Black tie. This is where the Managing Directors actually show up." },
  { id: "golf", name: "Golf Outing with Senior Bankers", cost: 350, energy: 30, networkingGain: [7, 12], commGain: [1, 2], blurb: "Four hours to make a lasting impression on a Partner." }
];

/* ---------------- Skill-training actions ---------------- */

DATA.TRAINING_ACTIONS = [
  { id: "network_train", skill: "networking", name: "Work the Room", cost: 0, energy: 12, gain: [1, 3] },
  { id: "comm_train", skill: "communication", name: "Toastmasters Session", cost: 40, energy: 10, gain: [1, 3] },
  { id: "sales_train", skill: "sales", name: "Shadow a Senior Banker's Pitch", cost: 0, energy: 15, gain: [1, 3] },
  { id: "discipline_train", skill: "discipline", name: "Morning Routine & Journaling", cost: 0, energy: 8, gain: [1, 3] }
];
